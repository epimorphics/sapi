...
public class ResultRDFXML implements MessageBodyWriter<Result> {
    static final Logger log = LoggerFactory.getLogger( ResultRDFXML.class );
    ...
    public void writeTo(Result result, Class<?> type, Type genericType,
        ...
        ResultTurtle.asModel(result).write(entityStream, "RDF/XML");
    }
